...
Поля класса:
 - `protected _submit: HTMLButtonElement;` защищенное поле для кнопки отправки формы;
 - `protected _errors: HTMLElement;` защищенное поле для отображения ошибок;
...
#### Класс Card
Наследует функциональность от Component и отвечает за отображение карточки, задавая в карточке данные названия, изображения, отношение к группе товаров, цену. Класс используется для отображения карточки товара. 
